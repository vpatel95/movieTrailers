import movie_page import movie
...
hercules = movie.Movie(
    "Hercules",  #  Movie Title
...
suicide_squad = movie.Movie(
    "Suicide Squad",  #  Movie Title

    "Group of metahumans and criminals fight against spir"
    "itual power to save the world", #  Storyline
